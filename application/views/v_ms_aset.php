...
<body id="layouts-horizontal">
                ...
                <div class="container">
                  <div class="row">
                    <div id="table-datatables">
                      <h4 class="header" style="text-align : center; margin-top:0px;">Master aset
                      </h4>
                      <div class="row">
                  ...
                  <!-- <div class="row">
                    ...
                    <div id="modal2" class="modal">
                      ...
                      <div class="modal-content">
                        <div class="row">
                          <form class="col s12" id="formValidate" enctype="multipart/form-data"  action="<?php echo base_url()?>ms_aset/proses_tambah" method="post">
                            <div class="row">
                              <div class="input-field col m6 s12">
                                <i class="mdi-action-account-circle prefix"></i>
                                <input id="name3" name="nama" type="text" required data-error=".errorTxt1">
                                <div class="errorTxt1"></div>
                                <label for="first_name">Nama aset</label>
                              </div>
                              <div class="input-field col m6 s12">
                                <i class="mdi-action-account-circle prefix"></i>
                      ...
                      <div id="modal_edit" class="modal">
                        ...
                        <div class="modal-content">
                          <div class="row">
                            <form class="col s12" id="formValidate" enctype="multipart/form-data"  action="<?php echo base_url()?>ms_aset/proses_edit" method="post">
                              <div class="row">
                                <div class="input-field col m6 s12">
                                  <i class="mdi-action-account-circle prefix"></i>
                                  <input id="nama" name="nama" type="text" required data-error=".errorTxt1">
                                  <div class="errorTxt1"></div>
                                  <label for="first_name" id="lbl_aset"  >Nama aset</label>
                                </div>
                                <div class="input-field col m6 s12">
                                  <i  class="mdi-action-account-circle prefix"></i>
    ...
    $(document).on('click', '.link_delete', function (e) {
     ...
     $(document).on('click', '.btn-edit', function (e) {
          $("#lbl_aset,#lbl_des").addClass("active");
    ...
    $("#example").dataTable({
        ...
        ajax: {
           type: "POST",
           url: "<?php echo base_url()?>ms_aset/get_aset/",
           dataType: 'json',
            beforeSend:function()
            {
