...
<!--================================================================================
	Item Name: Master peralatan Item
	Version: 1
	Author: Jancuk
================================================================================ -->
...
<body id="layouts-horizontal">
                ...
                <div class="container">
                  <div class="row">
                    <div id="table-datatables">
                      <h4 class="header" style="text-align : center; margin-top:0px;">Master Item peralatan <?php echo $data->nama ?>
                      </h4>
                      <div class="row">
                  ...
                  <!-- <div class="row">
                    ...
                    <div id="modal2" class="modal">
                      ...
                      <div class="modal-content">
                        <div class="row">
                          <form class="col s12" id="formValidate" enctype="multipart/form-data"  action="<?php echo base_url()?>ms_peralatanbpbd/proses_tambah_item" method="post">
                            <div class="row">
                              ...
                              <div class="input-field col m6 s12">
                                <i class="mdi-action-account-circle prefix"></i>
                                <input name="merek" type="text" required data-error=".errorTxt2">
                                <div class="errorTxt2"></div>
                                <label for="first_name">Merek/ Brand</label>
                              </div>
                            </div>
                            <div class="row">
                              <div class="input-field col m6 s12">
                                  <?php $kondisi = array("Baik", "Rusak");?>
                                  <select name="kondisi" required class="select"  data-error=".errorTxt12">
                                    <option value="" disabled selected> -- Kondisi Peralatan --</option>
                              ...
                              <div class="input-field col m6 s12">
                                  <?php $sumber = array("APBD", "APBN", "Lainnya");?>
                                  <select name="sumber" required class="select"  data-error=".errorTxt12">
                                    <option value="" disabled selected> -- Sumber Peralatan --</option>
                                ...
                                <div class="input-field col m6 s12">
                                <i class="mdi-action-account-circle prefix"></i>
                                <input id="" name="tahun" type="text" required data-error=".errorTxt5">
                              ...
                              <div class="input-field col m6 s12">
                                <i class="mdi-action-account-circle prefix"></i>
                                <input id="" name="deskripsi" type="text" required data-error=".errorTxt5">
                                <div class="errorTxt5"></div>
                      ...
                      <div id="modal_edit" class="modal">
                        ...
                        <div class="modal-content">
                          <div class="row">
                            <form class="col s12" id="formValidate" enctype="multipart/form-data"  action="<?php echo base_url()?>ms_peralatanbpbd/proses_edit_item" method="post">
                              <div class="row">
                                <div class="input-field col m6 s12">
                                  <i class="mdi-action-account-circle prefix"></i>
                                  <input id="nama" name="nama" type="text" required data-error=".errorTxt1">
                                  <div class="errorTxt1"></div>
                                  <label for="first_name" id="lbl_nama">Nama Peralatan</label>
                                </div>
                                <div class="input-field col m6 s12">
                                <i class="mdi-action-account-circle prefix"></i>
                                <input id="merek" name="merek" type="text" required data-error=".errorTxt2">
                                <div class="errorTxt2"></div>
                                <label for="first_name" id="lbl_merek">Merek/ Brand</label>
                              </div>
                            </div>
                            <div class="row">
                              <div class="input-field col m6 s12">
                              ...
                              <div class="input-field col m6 s12">
                                ...
                                <div class="input-field col m6 s12">
                                <i class="mdi-action-account-circle prefix"></i>
                                <input id="tahun" name="tahun" type="text" required data-error=".errorTxt5">
                                <div class="errorTxt5"></div>
                                <label for="first_name" id="lbl_tahun">Tahun</label>
                                <input name="id" value="<?php echo $id_md5?>" type="hidden">
                              </div>
                              <div class="input-field col m6 s12">
                                <i class="mdi-action-account-circle prefix"></i>
                                <input id="deskripsi" name="deskripsi" type="text" required data-error=".errorTxt5">
                                <div class="errorTxt5"></div>
                                <label for="first_name" id="lbl_deskripsi">Deskripsi</label>
    ...
    $(document).on('click', '.link_delete', function (e) {
     ...
     $(document).on('click', '.btn-edit', function (e) {
          $("#lbl_nama,#lbl_merek,#lbl_kondisi,#lbl_sumber,#lbl_tahun,#lbl_deskripsi").addClass("active");
          ...
          $("#nama").val(nama); $("#merek").val(merek);
          $("#id_edit").val(id); $("#sumber").val(sumber);
          $("#kondisi").val(kondisi); $("#tahun").val(tahun);
    ...
    $("#example").dataTable({
        ...
        ajax: {
           type: "POST",
           url: "<?php echo base_url()?>ms_peralatanbpbd/get_peralatanbpbd_item/<?php echo $id_md5?>",
           dataType: 'json',
            beforeSend:function()
            {
