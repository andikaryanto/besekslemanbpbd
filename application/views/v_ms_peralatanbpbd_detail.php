...
<!--================================================================================
	Item Name: Master peralatanbpbd detail
	Version: 1
	Author: Elos
================================================================================ -->
...
<body id="layouts-horizontal">
                ...
                <div class="container">
                  <div class="row">
                    <div id="table-datatables">
                      <h4 class="header" style="text-align : center; margin-top:0px;">Data Log peralatan <?php echo $data->nama ?>
                      </h4>
                      <div class="row">
                        <div class="col s12 m12 l12">
                          ...
                          <thead>
                              <tr>
                                  ...
                                  <th style="width: 10%;">Kondisi Awal</th>
                  ...
                  <!-- <div class="row">
                    ...
                    <div id="modal2" class="modal">
                      ...
                      <div class="modal-content">
                        <div class="row">
                          <form class="col s12" id="formValidate" enctype="multipart/form-data"  action="<?php echo base_url()?>ms_peralatanbpbd/proses_tambah_detail" method="post">
                            <div class="row">                
                              <div class="input-field col m6 s12">
                                <i class="mdi-action-account-circle prefix"></i>
                                <input name="cek_by" type="text" required data-error=".errorTxt2">
                                <div class="errorTxt2"></div>
                                <label for="first_name">Teknisi</label>
                              </div>
                            </div>
                            <div class="row">
                              <div class="input-field col m6 s12">
                                <i class="mdi-action-account-circle prefix"></i>
                                <input name="kondisi_awal" type="text" required data-error=".errorTxt2">
                                <div class="errorTxt2"></div>
                                <label for="first_name">Kondisi Awal</label>
                              </div>
                              <div class="input-field col m6 s12">
                                <i class="mdi-action-account-circle prefix"></i>
                                <input name="kondisi_akhir" type="text" required data-error=".errorTxt2">
                                <div class="errorTxt2"></div>
                                <label for="first_name">Kondisi Akhir</label>
                              </div>
                              <div class="input-field col m6 s12">
                                <i class="mdi-action-account-circle prefix"></i>
                      ...
                      <div id="modal_edit" class="modal">
                        ...
                        <div class="modal-content">
                          <div class="row">
                            <form class="col s12" id="formValidate" enctype="multipart/form-data"  action="<?php echo base_url()?>ms_peralatanbpbd/proses_edit_detail" method="post">
                              <div class="row">
                                <div class="row">                
                              <div class="input-field col m6 s12">
                                <i class="mdi-action-account-circle prefix"></i>
    ...
    $(document).on('click', '.link_delete', function (e) {
     ...
     $(document).on('click', '.btn-edit', function (e) {
          $("#lbl_tgl,#lbl_cek_by,#lbl_kondisi_awal,#lbl_kondisi_akhir,#lbl_deskripsi").addClass("active");

          var tgl = $(this).attr('data-tgl');
          var teknisi = $(this).attr('data-cek_by');
          var id = $(this).attr('data-id');
          var deskripsi = $(this).attr('data-deskripsi');
          var awal = $(this).attr("data-kondisi_awal");
          var akhir = $(this).attr("data-kondisi_akhir");

          $("#tgl").val(tgl); $("#cek_by").val(teknisi);
          $("#id_edit").val(id); $("#kondisi_awal").val(awal);
          $("#kondisi_akhir").val(akhir); $("#deskripsi").val(deskripsi);
    ...
    $("#example").dataTable({
        ...
        ajax: {
           type: "POST",
           url: "<?php echo base_url()?>ms_peralatanbpbd/get_peralatanbpbd_det/<?php echo $id_md5?>",
           dataType: 'json',
            beforeSend:function()
            {
