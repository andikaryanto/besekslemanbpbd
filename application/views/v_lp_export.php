...
<body id="layouts-horizontal">
          ...
          <div class="row">
            <div class="col s12 m12 l12">
              <div class="card-panel">
                ...
                <div class="row">
                  <form class="col s12" id="formValidate" enctype="multipart/form-data" target="_blank"
                    action="<?php echo base_url() ?>lp_export/proses" method="post">
                    ...
                    <div class="row">
                      ...
                      <div id="pilihan_bencana">
                        ...
                        <div class="input-field col m4 s12" style="padding-left:55px;">
                          ...
                          <select id="status_laporan" name="status_laporan" required class='select' data-error=".errorTxt122">
                    ...
                    <div class="row" id="row_kecamatan">
                      <div class="input-field col m4 s12" style="padding-left:55px;">
                        <select name="kecamatan" id="kecamatan" class="select" required title="Harap Di pilih"
                      ...
                      <div class="input-field col m4 s12" style="padding-left:55px;">
                        <select name="kelurahan" id="kelurahan" class="select" required title="Harap Di Pilih"
                          data-error=".errorTxt4">
                          <option value="" disabled selected> -- Pilih Kecamatan Terlebih Dahulu (Kosongkan Untuk Semua)
                            -- </option>
                        </select>
                      ...
                      <div class="row">
                        <div class="input-field col s12">
                          <select name="gudang[]" id="gudang" multiple data-error=".errorTxt3">
                            <option value="" disabled selected> -- Pilih Gudang (Kosongkan Jika ingin melihat di semua
                              gudang) --</option>
                      ...
                      <div class="row">
                        <div class="input-field col s12">
                          <select name="barang[]" multiple id="barang">
                            <option value="" disabled selected> -- Pilih Barang (Kosongkan Jika ingin melihat semua
                              barang) --</option>
                            <?php foreach ($barang as $row) { ?>
                              <option value="<?php echo $row->idtblbarang ?>"><?php echo $row->nama . ' (' . $row->uom . ')' ?>
                              </option>
                            <?php } ?>
                          </select>
                    ...
                    <div class="row" id="bencana_radio" style="padding-left:55px;">
                          <input id="excel" name="fileExport" type="radio" value="excel" checked />
                          <label style="top:0px;" for="excel">Excel</label>
                          <input id="pdf" name="fileExport" type="radio" value="pdf"/>
                          <label style="top:0px;" for="pdf">PDF</label>
                    </div>
  ...
  <script src="<?php echo base_url(); ?>assets/select2/select2.full.min.js" type="text/javascript"
  ...
  <script>
    ...
    $("#status_laporan").change(function (e) {
      var tr = $(this).val();
      $("#bencana_radio").fadeOut(700);
      
      if (tr == 'rekap') {
        $("#bencana_radio").fadeIn(700);
      }else{
        $("#bencana_radio").fadeOut(700);
      }
    });
